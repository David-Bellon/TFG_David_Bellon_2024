...
public class Master_Scenario2 : MonoBehaviour
{
    ...
    public class Car
    {
        public CarMove_Scenario2 car_data;
        public int _id;

        public Car(GameObject aux_car, int id)
        {
            car_data = aux_car.GetComponent<CarMove_Scenario2>();
            car_data.model = ModelLoader.Load((NNModel)Resources.Load($"Scenario2/individual_{id}"));
            _id = id;
        }
    }
